 ...
 * 
 * Run this script anytime to fetch the latest MGNREGA data and update the database.
 * 
 * Usage:
 *   npm run ingest
 *   OR
 *   node scripts/manual-ingest.mjs
 * 
 * This script will:
 * 1. Fetch latest data from data.gov.in API
 * 2. Insert new records into mgnrega_data table
 * 3. Recalculate all KPIs for district and state tables
...
async function fetchAndStoreAllData() {
  console.log("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
  console.log("🔧 Manual Data Ingestion Started");
  console.log(`⏰ Triggered at: ${new Date().toLocaleString('en-IN', { timeZone: 'Asia/Kolkata' })}`);
  console.log("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n");
  ...
  console.log(`   📥 Total records fetched: ${totalRecordsReceived}`);
  console.log(`   ➕ New records inserted: ${totalIngested}`);
  console.log(`   🔄 Duplicates skipped: ${totalRecordsReceived - totalIngested}`);
  console.log(`   📈 KPIs calculated: ${totalKPIsCalculated}\n`);
